...
function addTech(){
    let containerFilhos = container.children;
    for (let index = 0; index < containerFilhos.length; index += 1){
        if (containerFilhos[index].className = 'tech'){
            containerFilhos[index].classList.remove('tech');
        } else {
                console.log(secondDiv.classList.add('tech'));
        }
    }
}
